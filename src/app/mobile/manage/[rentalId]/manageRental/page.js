...
export default function ManageInventory({ params }) {
	...
	const [formData, setFormData] = useState({
		...
		employeeNum: '',
		loanDate: (new Date()).toLocaleDateString('sv-SE'),
		inventoryDate: (new Date()).toLocaleDateString('sv-SE'),
		remarks: '',
	});
	...
	return (
		<div className={styles.manageContainer}>
			<DetailHeader title='貸出' buttons={buttons} />
			<div className={styles.detailBody}>
				<table className={styles.editTable}>
					<tbody>
						...
						<tr><th>貸出日</th><td><input type='date' name='loanDate' value={formData.loanDate} onChange={handleInputChange} /></td></tr>
						<tr><th>棚卸日</th><td><input type='date' name='inventoryDate' value={formData.inventoryDate} onChange={handleInputChange} /></td></tr>
