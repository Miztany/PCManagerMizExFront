...
export default function FormRental(props) {
	...
	return (
		<div className={styles.formContainer}>
			...
			<input type='button' value='貸出完了' className={styles.detailButton} onClick={() => saveRecord(props.formUrl, formData, props.setMode)} />
		</div>
	)
}